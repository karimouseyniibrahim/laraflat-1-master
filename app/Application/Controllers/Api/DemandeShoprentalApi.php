...
use App\Application\Transformers\DemandeShoprentalTransformers;

class DemandeShoprentalApi extends Controller
{

    protected $request;
    protected $model;

    public function __construct(DemandeShoprental $model , Request $request)
    {
        $this->model = $model;
    ...
    public function index($limit = 10 , $offset = 0 , $lang = "en"){
       ...
       return response(apiReturn(DemandeShoprentalTransformers::transform($data))  , 200 );
    }
