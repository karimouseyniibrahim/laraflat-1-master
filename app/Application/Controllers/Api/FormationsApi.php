...
use App\Application\Transformers\FormationsTransformers;

class FormationsApi extends Controller
{

    protected $request;
    protected $model;

    public function __construct(Formations $model , Request $request)
    {
        $this->model = $model;
    ...
    public function index($limit = 10 , $offset = 0 , $lang = "en"){
       ...
       return response(apiReturn(FormationsTransformers::transform($data))  , 200 );
    }
