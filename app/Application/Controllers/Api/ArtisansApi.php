...
use App\Application\Transformers\ArtisansTransformers;

class ArtisansApi extends Controller
{

    protected $request;
    protected $model;

    public function __construct(Artisans $model , Request $request)
    {
        $this->model = $model;
    ...
    public function index($limit = 10 , $offset = 0 , $lang = "en"){
       ...
       return response(apiReturn(ArtisansTransformers::transform($data))  , 200 );
    }
