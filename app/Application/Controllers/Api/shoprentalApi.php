...
use App\Application\Transformers\shoprentalTransformers;

class shoprentalApi extends Controller
{

    protected $request;
    protected $model;

    public function __construct(shoprental $model , Request $request)
    {
        $this->model = $model;
    ...
    public function index($limit = 10 , $offset = 0 , $lang = "en"){
       ...
       return response(apiReturn(shoprentalTransformers::transform($data))  , 200 );
    }
